...
function createContainerComponent(useElement) {
  function ContainerComponent(props, forwardedRef) {
    ...
    (0, import_react2.useImperativeHandle)(forwardedRef, () => instance);
    return props.children == null ? null : import_react2.default.createElement(LeafletProvider, {
      value: context
    }, props.children);
  }
  return (0, import_react2.forwardRef)(ContainerComponent);
}
function createDivOverlayComponent(useElement) {
  function OverlayComponent(props, forwardedRef) {
    ...
    (0, import_react2.useImperativeHandle)(forwardedRef, () => instance);
    (0, import_react2.useEffect)(function updateOverlay() {
      if (isOpen) {
        instance.update();
      }
    }, [
  ...
  return (0, import_react2.forwardRef)(OverlayComponent);
}
function createLeafComponent(useElement) {
  ...
  return (0, import_react2.forwardRef)(LeafComponent);
}
...
function createControlHook(useElement) {
  return function useLeafletControl(props) {
    ...
    const positionRef = (0, import_react3.useRef)(props.position);
    const { position } = props;
    (0, import_react3.useEffect)(function addControl() {
    ...
    (0, import_react3.useEffect)(function updateControl() {
...
function createElementHook(createElement, updateElement) {
  ...
  return function useMutableLeafletElement(props, context) {
    ...
    const { instance } = elementRef.current;
    (0, import_react4.useEffect)(function updateElementProps() {
...
//# sourceMappingURL=chunk-3UMCJNWC.js.map
