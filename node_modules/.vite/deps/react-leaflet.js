...
function createControlledLayer(addLayerToControl) {
  return function ControlledLayer(props) {
    ...
    return props.children ? import_react2.default.createElement(LeafletProvider, {
      value: context
    }, props.children) : null;
  };
}
...
function MapContainerComponent({ bounds, boundsOptions, center, children, className, id, placeholder, style, whenReady, zoom, ...options }, forwardedRef) {
  ...
  (0, import_react3.useImperativeHandle)(forwardedRef, () => (context == null ? void 0 : context.map) ?? null, [
    context
  ]);
  ...
  const contents = context ? import_react3.default.createElement(LeafletProvider, {
    value: context
  }, children) : placeholder ?? null;
  return import_react3.default.createElement("div", _extends({}, props, {
    ref: mapRef
  }), contents);
}
...
function PaneComponent(props, forwardedRef) {
  ...
  return props.children != null && paneElement != null ? (0, import_react_dom.createPortal)(import_react4.default.createElement(LeafletProvider, {
    value: newContext
